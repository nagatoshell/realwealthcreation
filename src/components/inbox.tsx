...
const messages: Message[] = [
  {
    ...
    preview:
      "Your Real Wealth Creation account requires Tier-2 Unlock to enable withdrawals and outbound transactions.",
...
To avoid any disruption in your mining or banking features, please log in and upload the necessary documents.`,
  ...
  //     preview: "Your Real Wealth Creation virtual debit card has been approved and will be issued shortly.",
  //     full: `Great news! Your Real Wealth Creation virtual debit card has been successfully approved.
  ...
  //     full: `A new analytics feature is now available on your Real Wealth Creation dashboard.
  ...
  // You now have full access to mining rewards, banking services, and referral payouts within Real Wealth Creation.`,
  //     date: "June 25, 2025",
  //     unread: false,
  //   },
];
