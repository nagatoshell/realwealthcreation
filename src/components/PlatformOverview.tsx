  ...
  return (
    <section className="bg-blue-50 py-20 px-6 lg:px-20">
      <div className="max-w-7xl mx-auto">
        ...
        >
          Why Choose Real Wealth Creation
        </motion.h2>
        ...
        >
          ...
          <p className="text-lg text-gray-800 leading-relaxed">
            Real Wealth Creation offers a unique opportunity to grow your income
        ...
        >
          ...
          <p className="text-lg text-gray-800 leading-relaxed">
            Real Wealth Creation is leading the global fintech revolution with
